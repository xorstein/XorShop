...
public class OrderController {
	...
	public String listByPage(
		...
		model.addAttribute("activelink","8");
		LOGGER.info("OrderController | listByPage | loggedUser : " + loggedUser.toString());
		
		if (!loggedUser.hasRole("Admin") && !loggedUser.hasRole("Vendeur") && loggedUser.hasRole("Livreur")) {
	...
	public String viewOrderDetails(@PathVariable("id") Integer id, Model model, 
		...
		try {
			...
			if (loggedUser.hasRole("Admin") || loggedUser.hasRole("Vendeur")) {
	...
	public String deleteOrder(@PathVariable("id") Integer id, Model model, RedirectAttributes ra) {
		...
		try {
			...
			ra.addFlashAttribute("message", "La commande numéro  " + id + "a été supprimée avec succès.");
			
			LOGGER.info("OrderController | deleteOrder | message : " + "The order ID " + id + " has been deleted.");
	...
	public String editOrder(@PathVariable("id") Integer id, Model model, RedirectAttributes ra,
		...
		try {
			...
			model.addAttribute("activelink","8");
			model.addAttribute("pageTitle", "Modifier la commande (ID: " + id + ")");
			model.addAttribute("order", order);
	...
	public String saveOrder(Order order, HttpServletRequest request, RedirectAttributes ra) {
		...
		ra.addFlashAttribute("message", "La commande numéro " + order.getId() + " a été mise à jours.");
