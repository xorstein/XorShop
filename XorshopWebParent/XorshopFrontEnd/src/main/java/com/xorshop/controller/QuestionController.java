...
import com.xorshop.service.QuestionService;
...
public class QuestionController {
	...
	public String listQuestionsOfProductByPage(
		...
		if (page.getTotalPages() > 1) {
			...
			model.addAttribute("pageTitle", "Questions sur le produit: " + product.getName());
		}		
	...
	public String listQuestionsByCustomerByPage(
		...
		model.addAttribute("pageTitle", "Mes questions");
		model.addAttribute("reverseSortDir", sortDir.equals("asc") ? "desc" : "asc");
