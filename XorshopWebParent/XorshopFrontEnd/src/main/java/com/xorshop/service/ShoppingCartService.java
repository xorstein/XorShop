...
import com.xorshop.repository.CartItemRepository;
import com.xorshop.repository.ProductRepository;
import com.xorshop.service.impl.IShoppingCartService;
	...
	public Integer addProduct(Integer productId, Integer quantity, Customer customer) throws ShoppingCartException {
		...
		if (cartItem != null) {
			...
			if (updatedQuantity > 5) {
				...
				throw new ShoppingCartException("Impossible d'ajouter plus de " + quantity + " article(s)"
						+ " parce qu'il y a déjà " + cartItem.getQuantity() + " article(s) "
						+ "dans votre panier. La quantité maximale autorisée est de 5.");
			}
		} else {
