...
public class DashboardInfo {
	...
	private long newOrdersTodayCount;
	private Double profitPourcentToday;
	private Double gainToday;

	public long getNewOrdersTodayCount() {
		return newOrdersTodayCount;
	}

	public void setNewOrdersTodayCount(long newOrdersTodayCount) {
		this.newOrdersTodayCount = newOrdersTodayCount;
	}

	public Double getProfitPourcentToday() {
		return profitPourcentToday;
	}

	public void setProfitPourcentToday(Double profitPourcentToday) {
		this.profitPourcentToday = profitPourcentToday;
	}

	public Double getGainToday() {
		return gainToday;
	}

	public void setGainToday(Double gainToday) {
