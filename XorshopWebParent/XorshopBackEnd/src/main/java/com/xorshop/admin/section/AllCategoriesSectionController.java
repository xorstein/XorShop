...
public class AllCategoriesSectionController {
	...
	public String showForm(Model model) {
		...
		model.addAttribute("pageTitle", "Toutes les catégories de la section - Nouvel element");
	...
	public String saveSection(Section section, RedirectAttributes ra) {
		...
		ra.addFlashAttribute("message", "La section de type Toutes les catégories a été enregistrée avec succès.");
	...
	public String editSection(@PathVariable(name = "id") Integer id, RedirectAttributes ra,
		...
		try {
			...
			model.addAttribute("pageTitle", "Toutes les catégories de la section - Modifier l'element (Numéro: " + id + ")");
			model.addAttribute("activelink", "16");
			return "sections/all_categories_section_form";
