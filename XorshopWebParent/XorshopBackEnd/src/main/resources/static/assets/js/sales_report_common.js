...
function getChartTitle(period) {
	if (period == "last_7_days") return "Ventes au cours des 7 derniers jours";
	if (period == "last_28_days") return "Ventes au cours des 28 derniers jours";
	if (period == "last_6_months") return "Ventes au cours des 6 derniers mois";
	if (period == "last_year") return "Ventes l’année dernière";
	if (period == "custom") return "Plage de dates";
