...
import com.xorshop.security.oauth.CustomerOAuth2UserService;
import com.xorshop.security.oauth.OAuth2LoginSuccessHandler;
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				.requestMatchers("/account_details", "/update_account_details", "/orders/**", "/cart",
						"/address_book/**", "/reviews/**", "/checkout", "/place_order", "/process_paypal_order",
						"/write_review/**", "/post_review", "/customer/questions/**", "/post_question/**",
						"/ask_question/**")
				.authenticated()
