...
import com.xorshop.common.entity.AbstractAddress;
...
public class Order extends AbstractAddress implements Serializable{
	...
	public String getProductNames() {
		...
		productNames = "<ul class=\"list-group\">";

		for (OrderDetail detail : orderDetails) {
			productNames += "<li class=\"list-group-item\">" + detail.getProduct().getShortName() + "</li>";			
		}
	...
	@Transient
	public String getProductNamesSimple() {
		String productNames = "";
